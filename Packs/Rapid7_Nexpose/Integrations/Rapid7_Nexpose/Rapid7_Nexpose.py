...
# 2. Add report formats enum (pdf, rtf, xml, html, text)
...
def get_scan_entry(scan: dict) -> CommandResults:
    ...
    """
    # TODO: Convert output to CommandResults?
...
def replace_key_names(data: Union[dict, list, tuple, set], name_mapping: dict,
    ...
    Returns:
        Union[dict, list, tuple, set]: The same data-structure with key names of dicts replaced according to mapping.
    """
    for item in data:
...
def get_assets_command(client: Client, sort: Union[str, None] = None, limit: Union[int, None] = None) -> CommandResults:
    """
    Retrieve a list of all assets.
